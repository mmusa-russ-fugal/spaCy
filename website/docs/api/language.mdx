...
{/* BLOCKLY-PIPELINE-BUILDER: preset "api-add-pipe" (src/widgets/blockly/presets.ts).
Minimal "snippet" mode: a single add_pipe block with fields for the
...
above can't be produced here. TODO: a config= field. */}
